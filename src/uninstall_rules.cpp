...
int main() {
  ...
  int r1 =
      system("netsh advfirewall firewall delete rule name=\"NetTransfer UDP\"");
  int r2 =
      system("netsh advfirewall firewall delete rule name=\"NetTransfer TCP\"");
...
int main() {
  ...
  std::cout << "On Linux, NetTransfer uses standard ports that don't require "
               "special rules.\n";
  return 0;
}
#endif
